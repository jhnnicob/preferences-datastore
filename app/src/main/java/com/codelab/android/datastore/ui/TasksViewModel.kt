...
import com.codelab.android.datastore.data.UserPreference
...
class TasksViewModel(
    ...
    private val tasksUiModelFlow = combine(
        repository.tasks,
        userPreferencesFlow,
    ) { tasks: List<Task>, userPreference: UserPreference ->
        return@combine TasksUiModel(
            tasks = filterSortTasks(tasks, userPreference.showCompleted, userPreference.sortOrder),
